    ...
    <DashboardLayout>
      ...
      <div className="col-span-12 row-span-1 flex items-center justify-between bg-slate-900/50 border-b border-cyan-500/30 px-6 py-2 backdrop-blur-md">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-600 uppercase">
            Gas PE Pipeline Multivariate Quality Control Platform
          </h1>
        </div>
      ...
      <div className="col-span-6 row-span-11 grid grid-rows-12 gap-4">
        ...
        <div className="row-span-2 grid grid-cols-3 gap-4">
          ...
          <DashboardPanel title="Production Count" className="col-span-1 flex flex-col items-center justify-center">
             <div className="text-2xl lg:text-3xl font-mono text-cyan-400 font-bold">1,284</div>
             <div className="text-[10px] text-slate-400 uppercase tracking-wider mt-1">Pipes Produced</div>
          </DashboardPanel>
          <DashboardPanel title="Running Time" className="col-span-1 flex flex-col items-center justify-center">
             <div className="text-2xl lg:text-3xl font-mono text-blue-400 font-bold">48h</div>
             <div className="text-[10px] text-slate-400 uppercase tracking-wider mt-1">Continuous Operation</div>
          </DashboardPanel>
        </div>

        {/* Main Real-time Data Chart */}
        <DashboardPanel title="Real-time Data Acquisition (d, h, u)" className="row-span-10 relative">
          <div className="absolute top-4 right-4 flex gap-4 text-xs z-20">
             <div className="flex items-center gap-1"><span className="w-3 h-1 bg-cyan-500"></span> Diameter</div>
             <div className="flex items-center gap-1"><span className="w-3 h-1 bg-emerald-500"></span> Thickness</div>
             <div className="flex items-center gap-1"><span className="w-3 h-1 bg-rose-500"></span> Unroundness</div>
          </div>
      ...
      <div className="col-span-3 row-span-11 grid grid-rows-12 gap-4">
        ...
        <DashboardPanel title="Recommended Instructions" className="row-span-5">
        ...
        <DashboardPanel title="Equipment Alarm Info" className="row-span-4">
          <SystemStatus />
        </DashboardPanel>
      </div>
    </DashboardLayout>
